...
NOTE: Solace Quarkus Extension 3.2.0 is based on Quarkus 3.15.x with Java 17 as baseline.

Starting from 3.2.0 the extension also supports Solace JCSMP API alongside Solace Java Messaging API. This extension can be used in two ways
